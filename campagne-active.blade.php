...
@section('title', app_name() . ' | ' . __('applicazione.campagne') . ' | ' . 'Open')
...
<div class="kt-holder kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
    ...
    <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            @endif 
                    ...
                    <a href="{{ url('/offers') }}"><i style="color:black;" class="material-icons nav__icon" id="bookmark">work</i></a>
                        <a href="{{route('frontend.user.campagne.influencer',$campagna->uuid)}}"><i style="color:black;" class="material-icons nav__icon" id="bookmark">search</i></a>
                            ...
                            <a href="{{route('frontend.user.campagne.disattiva',$campagna->uuid)}}"><i style="color:black;" class="material-icons nav__icon" id="bookmark">power_settings_new</i></a>
        ...
        <p style="font-size:12px; text-align:center;background-image: linear-gradient(#e72b38, #e72b80);-webkit-background-clip: text;-webkit-text-fill-color: transparent;" class="card-text">Vedi qua le tue campagne aperte</p>
        </div>
        </br>
        </br>
        @endif
