...
class PersonaController extends Controller
{
    ...
    {   
$categorie = Categorie::inRandomOrder()->get();
       ...
       // $showRecaptcha = GoogleRecaptcha::show('6LeaQLgZAAAAAM9k3w4nb0JK8QivBbVhFQ5TWlH9', 'password_confirmation', 'no_debug', 'mt-3','Please tick the reCAPTCHA checkbox first!');
        ...
        return view('frontend.auth.persona')->with('categorie', $categorie)
    ...
    public function register(RegisterRequest $request)
    {
        ...
        $user = $this->userRepository->create($request->only('first_name', 'last_name', 'username', 'email', 'password', 'register_as'));
