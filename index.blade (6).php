...
<div>
    <div class="row_1">
        ...
        <div data-toggle="modal" data-target="#userListModal">
            <i style="background-image: linear-gradient(#e72b38, #e72b80);-webkit-background-clip: text;-webkit-text-fill-color: transparent; font-size:30px;" class="material-icons nav__icon">monetization_on</i>
        </div>
    </div>
    ...
    <div class="new_row">
       ...
       <i id="coin_shadow"  style="background-image: linear-gradient(#ffc905,#ffd84b8c, #9d7f03);-webkit-background-clip: text;-webkit-text-fill-color: transparent; font-size:150px;" class="material-icons nav__icon">monetization_on</i>
        ...
        <p style="font-size:20px; text-align:center; color:black;" class="card-text"><span><span>@lang('Coins'): </span><strong>{{$budget}}</strong></span></p>
...
<div style="display:flex; justify-content:center;">
    <div id="coin_scroll" style="display: flex;width: 100vw;flex-direction: row;flex-wrap: nowrap;justify-content: space-evenly;align-items: center;">
        ...
        <div class="coin_card">
            <i style="background-image: linear-gradient(#ab6e00,#ffb64b8c, #876d02);-webkit-background-clip: text;-webkit-text-fill-color: transparent; font-size:30px;" class="material-icons nav__icon">monetization_on</i>
        ...
        <div class="coin_card">
            <i style="background-image: linear-gradient(#d2dadd,#ecf7f7, #bbbbbb);-webkit-background-clip: text;-webkit-text-fill-color: transparent; font-size:30px;" class="material-icons nav__icon">monetization_on</i>
        ...
        <div class="coin_card">
            <i style="background-image: linear-gradient(#ffc905,#ffd84b8c, #9d7f03);-webkit-background-clip: text;-webkit-text-fill-color: transparent; font-size:30px;" class="material-icons nav__icon">monetization_on</i>
