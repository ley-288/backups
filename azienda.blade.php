...
@section('title', app_name() . ' | ' . __('Azienda'))
@push('after-styles')
            ...
            <div id="overhead_logo" style="height:200px; background-color:#e72b38;" class="kt-grid__item kt-grid__item--fluid  kt-grid__item--order-tablet-and-mobile-1  kt-login__wrapper">
                <div>
                    ...
                    <p id="phrase_lungo_1" style="color:white;">
                        ...
                        Vorresti dare visibilità o aumentare quella che già dai al tuo negozio? </br>
                        Hai una startup o una piccola azienda locale? </br>
                        <strong>Spidergain</strong> può aiutarti a trovare i contatti giusti per aumentare le tue vendite.
