...
class SocialiteHelper
{
    ...
    public function getSocialLinks()
    {
        ...
        if (config('services.apple.active')) {
            $socialite_enable[] = "<a href='".route('frontend.auth.social.login', 'apple')."' class='btn btn-sm btn-outline-info m-1'><i class='fab fa-apple'></i>  ".__('labels.frontend.auth.login_with', ['social_media' => 'Apple']).'</a>';
        }
