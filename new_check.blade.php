...
@section('title', app_name() . ' | ' . __('Check-In'))
...
<div id="locationModal"> 
        <div id="map-render">
            <i id="photo_icon_card_image" class="material-icons nav__icon">place</i>
            ...
            <div>
                <form style="overflow-x:hidden;" id="form-new-post">
                    <input type="hidden" name="group_id" value="">
                        ...
                        <textarea id="check_content" style="margin-top:-10px; height:75px;" rows = '8' name="content" class="content" placeholder="@lang('applicazione.cosa_stai_pensando')"></textarea>
                        <textarea style="margin-top:-20px; height:75px;" id="locazioni" rows = '8' name='location' class="form-control location-input" placeholder='' value="" ></textarea>   
                        ...
                        <div id="button_container">
                            ...
                            <div class="findMyLocation">
                                <a href="javascript:;" onclick="findPostLocation({{ $user->id }})"> 
                                    <div class="btn btn-default" id="positive">
                            ...
                            <div>
                                <button class="btn btn-default" type="button" id="negative" disabled onclick="newCheckInModal();">
...
function CopyToHashtagArea() {
    document.getElementById('check_content').removeAttribute('readonly');
  var txt = $("#check_content").val();
  $("#check_content").val(txt + "#");
}
