...
<div class="kt-grid__item kt-grid__item--fluid kt-app__content" id="kt_chat_content">
    <div class="kt-chat">
        <div style="max-width:470px;"  class="kt-portlet kt-portlet--head-lg kt-portlet--last">
                ...
                <div class="kt-chat__head ">
                    ...
                    <div class="kt-chat__center">
                        <div class="kt-chat__label">
                            <a href="#" class="kt-chat__title">@lang('Talks')</a>
                        </div>
                        @role('brand')
                            <span class="kt-chat__status">
                                <span class="kt-badge kt-badge--dot kt-badge--success"></span> @lang('Chiarimenti riguardo la campagna.')
                            </span>
                            @endrole
                    </div>
