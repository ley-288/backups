...
class CategorySelectController extends Controller {
    ...
    public function create(Request $request) {
        ...
        return view('frontend.user.completa-categoria')->with('categorie', $categorie)->with('user', $user);
    }
    ...
    public function edit(Request $request) {
        ...
        return view('frontend.user.completa-categoria')->with('categorie', $categorie)->with('dettagli', $dettagli)->with('user', $user);
